      ...
      <div class="tw-flex-none tw-w-full tw-max-w-full">
        <div class="tw-relative tw-flex tw-flex-col tw-min-w-0 tw-mb-6 tw-break-words tw-bg-white tw-border-0 tw-border-transparent tw-border-solid tw-shadow-xl dark:bg-slate-850 dark:shadow-dark-xl tw-rounded-2xl tw-bg-clip-border">
          <div class="tw-p-6 tw-pb-0 tw-mb-0 tw-border-b-0 border-b-solid tw-rounded-t-2xl border-b-transparent">
            <h6>Liste de tous les membres</h6>
          </div>
          <div class="tw-flex-auto tw-px-0 tw-pt-0 tw-pb-2">
            <div class="tw-p-0 tw-overflow-x-auto">
              <table class="tw-items-center tw-w-full tw-mb-0 tw-align-top tw-border-collapse dark:border-white/40 text-slate-500">
                ...
                <tr>
                  <th class="tw-px-6 tw-py-3 tw-font-bold tw-text-left tw-uppercase tw-align-middle tw-bg-transparent tw-border-b tw-border-collapse tw-shadow-none text-xxs border-b-solid tracking-none tw-whitespace-nowrap text-slate-400 tw-opacity-70">Nom & Prénoms</th>
                  <th class="tw-px-6 tw-py-3 tw-pl-2 tw-font-bold tw-text-left tw-uppercase tw-align-middle tw-bg-transparent tw-border-b tw-border-collapse tw-shadow-none text-xxs border-b-solid tracking-none tw-whitespace-nowrap text-slate-400 tw-opacity-70">Fonction</th>
                  <th class="tw-px-6 tw-py-3 tw-font-bold tw-text-center tw-uppercase tw-align-middle tw-bg-transparent tw-border-b tw-border-collapse tw-shadow-none text-xxs border-b-solid tracking-none tw-whitespace-nowrap text-slate-400 tw-opacity-70">Status</th>
                  <th class="tw-px-6 tw-py-3 tw-font-bold tw-text-center tw-uppercase tw-align-middle tw-bg-transparent tw-border-b tw-border-collapse tw-shadow-none text-xxs border-b-solid tracking-none tw-whitespace-nowrap text-slate-400 tw-opacity-70">Inscrit le</th>
                  <th class="tw-px-6 tw-py-3 tw-font-semibold tw-capitalize tw-align-middle tw-bg-transparent tw-border-b tw-border-collapse tw-border-solid tw-shadow-none text-xxs border-b-solid tracking-none tw-whitespace-nowrap text-slate-400 tw-opacity-70"></th>
                </tr>
                </thead>
                <tbody>
                ...
                <tr v-else v-for="(member, index) in members" :key="index">
                  <td class="tw-p-2 tw-align-middle tw-bg-transparent tw-border-b dark:border-white/40 tw-whitespace-nowrap shadow-transparent">
                    <div class="tw-flex tw-px-2 tw-py-1">
                      ...
                      <div class="tw-flex tw-flex-col tw-justify-center">
                        <h6 class="tw-mb-0 tw-text-sm tw-leading-normal">{{ member.lastname }} {{ member.firstname }}</h6>
                        <p class="tw-mb-0 tw-text-xs tw-leading-tight text-slate-400">{{ member.email }}</p>
                      </div>
                    </div>
                  </td>
                  <td class="tw-p-2 tw-align-middle tw-bg-transparent tw-border-b dark:border-white/40 tw-whitespace-nowrap shadow-transparent">
                    <p class="tw-mb-0 tw-text-xs tw-font-semibold tw-leading-tight">{{ member.fonction }}</p>
                    <p class="tw-mb-0 tw-text-xs tw-leading-tight text-slate-400">Organisation</p>
                  </td>
                  <td class="tw-p-2 tw-text-sm tw-leading-normal tw-text-center tw-align-middle tw-bg-transparent tw-border-b dark:border-white/40 tw-whitespace-nowrap shadow-transparent">
                    <span class="tw-bg-teal-400 tw-px-2.5 tw-text-xs tw-rounded-lg tw-py-1.5 tw-inline-block tw-whitespace-nowrap tw-text-center tw-align-baseline tw-font-bold tw-uppercase tw-leading-none tw-text-white">Active</span>
                  </td>
                  <td class="tw-p-2 tw-text-center tw-align-middle tw-bg-transparent tw-border-b dark:border-white/40 tw-whitespace-nowrap shadow-transparent">
                    <span class="tw-text-xs tw-font-semibold tw-leading-tight text-slate-400 tw-capitalize">{{ formatDateWithoutHour(member.created_at) }}</span>
                  </td>
                  <td class="tw-p-2 tw-align-middle tw-bg-transparent tw-border-b dark:border-white/40 tw-whitespace-nowrap shadow-transparent">
                    <NuxtLink :to="`/admin/members/${member.id}`" class="tw-text-xs tw-font-semibold tw-leading-tight tw-text-white tw-uppercase tw-rounded-lg tw-bg-gray-600 tw-px-4 tw-py-2">
                      Voir plus
                      <v-icon size="18" class="tw-ml-1 tw-mb-1" color="white">mdi-eye</v-icon>
                    </NuxtLink>
                  </td>
                </tr>
                </tbody>
